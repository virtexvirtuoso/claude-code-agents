...
description: Create, improve, or audit technical documentation — API docs, developer guides, READMEs, architecture docs, tutorials, runbooks, and changelogs.\n\n<example>\nuser: "Document our REST API for external developers. 30+ endpoints"\nassistant: "I'll use the technical-writer agent to create comprehensive API documentation."\n</example>\n\n<example>\nuser: "New engineers take weeks to get productive. We need better onboarding docs"\nassistant: "I'll use the technical-writer agent to create a developer onboarding guide."\n</example>\n\n<example>\nuser: "Our on-call engineers need runbooks for common incidents"\nassistant: "I'll use the technical-writer agent to create operational runbooks."\n</example>
model: inherit
color: cyan
---
