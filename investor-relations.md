...
description: Manage investor communications, term sheet analysis, due diligence prep, cap table management, and investor updates.\n\n<example>\nuser: "Got a term sheet from a VC. Help me understand and negotiate"\nassistant: "I'll use the investor-relations agent to analyze key terms and prepare your counter-proposal."\n</example>\n\n<example>\nuser: "We're entering due diligence. What do I need to prepare?"\nassistant: "I'll use the investor-relations agent to create a checklist and organize your data room."\n</example>
model: inherit
color: green
---
