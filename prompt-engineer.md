...
description: Design, optimize, and debug prompts for LLM applications. Covers system prompts, few-shot examples, token optimization, evaluation frameworks, and injection hardening.\n\n<example>\nuser: "Create a system prompt for a customer support agent"\nassistant: "I'll use the prompt-engineer agent to design a prompt with persona, boundaries, and guardrails."\n</example>\n\n<example>\nuser: "My classification prompt keeps giving different formats"\nassistant: "I'll use the prompt-engineer agent to debug and add format constraints."\n</example>\n\n<example>\nuser: "This prompt uses too many tokens. Make it more efficient"\nassistant: "I'll use the prompt-engineer agent to compress while maintaining effectiveness."\n</example>
model: opus
color: purple
---
