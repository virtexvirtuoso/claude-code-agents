...
description: Design, build, and optimize data dashboards with API integrations and caching (Redis, in-memory, client-side). Covers dashboard architecture, performance optimization, and rate limit handling.\n\n<example>\nuser: "How do I integrate a REST API for live dashboard updates with minimal latency?"\nassistant: "I'll use the dashboard-wizard agent to design an efficient API integration with caching."\n</example>\n\n<example>\nuser: "My dashboard lags due to frequent database queries"\nassistant: "I'll use the dashboard-wizard agent to implement an optimal caching strategy."\n</example>\n\n<example>\nuser: "How do I handle API rate limits while maintaining dashboard reliability?"\nassistant: "I'll use the dashboard-wizard agent to design caching and fallback mechanisms."\n</example>
model: inherit
color: yellow
---
