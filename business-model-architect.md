...
description: Design or refine business models, pricing strategies, revenue models, and unit economics.\n\n<example>\nuser: "How should I price my project management tool?"\nassistant: "I'll use the business-model-architect agent to design pricing and model unit economics."\n</example>\n\n<example>\nuser: "50K free users but no revenue. How do we monetize?"\nassistant: "I'll use the business-model-architect agent to design a monetization strategy."\n</example>
model: inherit
color: yellow
---
