...
description: Use this agent when you need to perform security assessments, vulnerability analysis, or secure code reviews. This includes authentication system audits, pre-deployment security validation, incident response analysis, SOC 2 compliance gap assessment, and third-party API integration security review. Distinct from code-review skill (general code quality) and api-security-specialist (API-specific deep dives) by providing comprehensive application security assessment.
model: opus
color: orange
---
