...
description: Create, modify, debug, and optimize TradingView Pine Script code. Covers custom indicators, trading strategies, repainting fixes, version migration, alerts, and webhooks.\n\n<example>\nuser: "I need an RSI divergence indicator for TradingView"\nassistant: "I'll use the pine-script-developer agent to create this indicator."\n</example>\n\n<example>\nuser: "My v4 script keeps repainting. Fix it and upgrade to v6"\nassistant: "I'll use the pine-script-developer agent to debug repainting and migrate to v6."\n</example>\n\n<example>\nuser: "Build a breakout strategy with ATR-based stops"\nassistant: "I'll use the pine-script-developer agent to implement this strategy."\n</example>
model: inherit
color: cyan
---
