...
description: Validate market opportunities, customer discovery, product-market fit assessment, and TAM/SAM/SOM sizing.\n\n<example>\nuser: "How do I validate if there's a real market for my remote meetings tool?"\nassistant: "I'll use the market-validator agent to design validation and size the market."\n</example>\n\n<example>\nuser: "Investors want TAM/SAM/SOM. How do I calculate properly?"\nassistant: "I'll use the market-validator agent for bottoms-up market sizing."\n</example>
model: inherit
color: teal
---
