...
description: Publication-quality data visualizations, chart type selection, and production-grade Plotly code. Covers colorblind-safe palettes, interactive dashboards, and figures for reports or publications.\n\n<example>\nuser: "Revenue data for 12 product lines over 3 years — best way to show trends?"\nassistant: "I'll use the data-visualization-architect agent to recommend chart types and provide Plotly code."\n</example>\n\n<example>\nuser: "Build an interactive equity curve with drawdown overlay and hover details"\nassistant: "I'll use the data-visualization-architect agent to design this interactive visualization."\n</example>\n\n<example>\nuser: "Compare return distributions across 4 trading strategies"\nassistant: "I'll use the data-visualization-architect agent to create distribution visualizations with annotations."\n</example>
model: inherit
color: purple
---
