...
description: Real-time, event-driven systems with sub-100ms latency — WebSocket architecture, streaming pipelines, backpressure handling, state synchronization, and reconnection strategies. Distinct from async-pattern-analyzer (code patterns) by focusing on system architecture.\n\n<example>\nuser: "My Bybit WebSocket disconnects every few hours and I lose order book state"\nassistant: "I'll use the realtime-systems-architect agent to design a reconnection state machine with snapshot recovery."\n</example>\n\n<example>\nuser: "During high volatility, my order book updates lag behind"\nassistant: "I'll use the realtime-systems-architect agent to implement backpressure handling."\n</example>\n\n<example>\nuser: "My signal-to-order latency is 200ms. How do I get it under 50ms?"\nassistant: "I'll use the realtime-systems-architect agent to profile your pipeline for bottlenecks."\n</example>
model: inherit
color: orange
---
