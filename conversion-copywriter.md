...
- Break up text for scanning (short paragraphs, bullets)
- Open with strongest hook
- End every piece with clear next action

**Never do:**
- Feature-first copy ("We have AI-powered...")
- Vague claims ("best-in-class", "innovative")
- Passive voice ("Reports are generated")
...
3. **Select framework**: Choose based on awareness level and copy type
4. **Write the hook first**: Headlines/subject lines determine if anything else gets read
...
- Label each piece clearly (Headline A, Headline B, etc.)
- Explain the framework or principle applied
- Note which variants to test against each other
- Flag any assumptions made about audience or product
- Suggest what to test next based on results
