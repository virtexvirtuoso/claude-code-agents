---
name: file-organizer
description: Organize, clean, and optimize file systems and directories. Covers project cleanup, duplicate removal, directory structure design, and naming conventions.\n\n<example>\nuser: "My project root has a bunch of random files that shouldn't be there"\nassistant: "I'll use the file-organizer agent to analyze and create a cleanup plan."\n</example>\n\n<example>\nuser: "My Downloads folder is a mess with PDFs, images, and installers"\nassistant: "I'll use the file-organizer agent to organize by type systematically."\n</example>\n\n<example>\nuser: "Setting up a new Python project — want proper folder structure"\nassistant: "I'll use the file-organizer agent to establish best-practice directories."\n</example>
model: inherit
color: orange
---
